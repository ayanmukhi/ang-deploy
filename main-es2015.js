...
let CounselorProfileComponent = class CounselorProfileComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let LoginComponent = class LoginComponent {
    constructor(fb, _apiservice, route) {
        this.fb = fb;
    ...
    onSubmit() {
        this._apiservice.login(this.loginForm.value)
            .subscribe(data => this.saveData(data), error => this.errorData(error));
    }
    errorData(error) {
...
let SeekerProfileComponent = class SeekerProfileComponent {
    constructor() { }
    ngOnInit() {
    }
};
